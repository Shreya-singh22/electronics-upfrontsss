    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-32 text-center">
          ...
          <Link to="/products" className="inline-flex h-12 px-8 rounded-xl bg-primary text-primary-foreground font-bold items-center justify-center hover:opacity-90 transition-opacity">
            Back to Shop
          </Link>
        </div>
        <Footer />
