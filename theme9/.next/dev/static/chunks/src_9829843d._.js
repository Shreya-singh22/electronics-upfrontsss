...
const StoreProvider = ({ children })=>{
    ...
    const addToCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[addToCart]": (product, quantity = 1, variants)=>{
            setCart({
                "StoreProvider.useCallback[addToCart]": (prev)=>{
                    const existing = prev.find({
                        "StoreProvider.useCallback[addToCart].existing": (item)=>item.id === product.id
                    }["StoreProvider.useCallback[addToCart].existing"]);
                    if (existing) {
                        return prev.map({
                            "StoreProvider.useCallback[addToCart]": (item)=>item.id === product.id ? {
                                    ...item,
    ...
    const removeFromCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[removeFromCart]": (id)=>{
            setCart({
                "StoreProvider.useCallback[removeFromCart]": (prev)=>prev.filter({
                        "StoreProvider.useCallback[removeFromCart]": (item)=>item.id !== id
    ...
    const updateQuantity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[updateQuantity]": (id, quantity)=>{
            if (quantity <= 0) {
                setCart({
                    "StoreProvider.useCallback[updateQuantity]": (prev)=>prev.filter({
                            "StoreProvider.useCallback[updateQuantity]": (item)=>item.id !== id
    ...
    const toggleWishlist = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[toggleWishlist]": (product)=>{
            setWishlist({
                "StoreProvider.useCallback[toggleWishlist]": (prev)=>prev.find({
                        "StoreProvider.useCallback[toggleWishlist]": (p)=>p.id === product.id
                    }["StoreProvider.useCallback[toggleWishlist]"]) ? prev.filter({
                        "StoreProvider.useCallback[toggleWishlist]": (p)=>p.id !== product.id
    ...
    const isInWishlist = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[isInWishlist]": (id)=>wishlist.some({
                "StoreProvider.useCallback[isInWishlist]": (p)=>p.id === id
            }["StoreProvider.useCallback[isInWishlist]"])
    }["StoreProvider.useCallback[isInWishlist]"], [
        wishlist
    ]);
...
_s(StoreProvider, "mcivNYjWPdRt0Lhb7KF+jU3ib8M=");
_c = StoreProvider;
const useStore = ()=>{
    _s1();
...
var _s = __turbopack_context__.k.signature();
;
const API_BASE_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || 'http://localhost:5000/api/storefront/public';
class StorefrontAPI {
    ...
    static get subdomain() {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_SUBDOMAIN || 'preview';
    }
...
function useStore() {
    _s();
    const [customization, setCustomization] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // 1. Fetch initial live data on load
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useStore.useEffect": ()=>{
            StorefrontAPI.getStoreCustomization().then({
                "useStore.useEffect": (data)=>data && setCustomization(data)
            }["useStore.useEffect"]);
        }
    }["useStore.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useStore.useEffect": ()=>{
            const handleMessage = {
                "useStore.useEffect.handleMessage": (e)=>{
                    if (e.data?.type === 'ORBIT_CUSTOMIZATION_UPDATE') {
                        setCustomization({
                            "useStore.useEffect.handleMessage": (prev)=>({
                                    ...prev,
                                    ...e.data.data
                                })
                        }["useStore.useEffect.handleMessage"]);
                    }
                }
            }["useStore.useEffect.handleMessage"];
            window.addEventListener('message', handleMessage);
            return ({
                "useStore.useEffect": ()=>window.removeEventListener('message', handleMessage)
            })["useStore.useEffect"];
        }
    }["useStore.useEffect"], []);
    return {
...
_s(useStore, "cow7zPI77wYijKlUK7mdwHYTkQc=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/contexts/store-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StoreProvider({ children }) {
    _s();
    const storeData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StoreContext.Provider, {
        value: storeData,
        children: children
    }, void 0, false, {
        fileName: "[project]/src/contexts/store-context.tsx",
        lineNumber: 11,
        columnNumber: 9
    }, this);
}
_s(StoreProvider, "aqu95m/OoGPUyBcjEKb7zl1vQ4k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"]
    ];
});
_c = StoreProvider;
...
//# sourceMappingURL=src_9829843d._.js.map