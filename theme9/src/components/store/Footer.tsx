...
const Footer = () => (
  <footer className="border-t border-border bg-secondary/10 pt-16 pb-8">
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-display text-xl font-bold text-foreground">VoltTech</span>
          </div>
          <p className="text-sm text-muted-foreground leading-relaxed mb-5">
            Your trusted destination for premium electronics. Authentic products, unbeatable prices.
          </p>
      ...
      <div className="border-t border-border pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
        <p className="text-xs text-muted-foreground">© 2026 VoltTech. All rights reserved.</p>
