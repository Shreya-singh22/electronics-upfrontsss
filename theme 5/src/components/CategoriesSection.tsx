    ...
    >
      ...
      <div className="container mx-auto px-4 z-10 relative">
        <div className="flex flex-col items-center justify-between mb-12 md:mb-16 gap-6">
          ...
          <Link to="/products" className="group flex items-center gap-2 text-sm font-bold text-blue-400 hover:text-blue-300 transition-colors bg-blue-500/10 px-6 py-3 rounded-full border border-blue-500/20 hover:border-blue-400 hover:shadow-[0_0_20px_rgba(59,130,246,0.3)]">
