...
export default function ReviewsSection() {
    ...
    const title = customization?.reviewsSection?.title || "What Our Clients Say";
    const subtitle = customization?.reviewsSection?.subtitle || "\"Because your joy is our ultimate gadget.\"";
    const reviewsList = customization?.reviewsSection?.reviews || [
        {
            name: "Aman Sharma",
    ...
    return (
        <section onClick={handleSectionClick} className="py-24 bg-secondary/50 overflow-hidden relative cursor-pointer">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    <h2 className="font-heading font-black text-4xl md:text-5xl text-foreground mb-4">{title}</h2>
