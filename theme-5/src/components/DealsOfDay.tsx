                    ...
                    {dealProducts.map((p) => {
                        ...
                        return (
                            <div key={p.id} className="relative group">
                                <Link href={`/product/${p.id}`} className="block bg-[#0a0a0a] rounded-[2rem] border border-white/5 p-6 hover:border-red-500/30 hover:shadow-[0_0_40px_rgba(239,68,68,0.15)] transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
