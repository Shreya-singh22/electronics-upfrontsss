...
export default function DealsOfDay() {
    ...
    return (
        <section onClick={handleSectionClick} className="py-16 bg-background relative overflow-hidden cursor-pointer">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="font-heading font-black text-2xl md:text-3xl text-foreground">
                                {customization?.dealsOfDay?.title || "Deals of the Day"}
                            </h2>
                            <p className="text-sm md:text-base text-muted-foreground mt-1">
                                {customization?.dealsOfDay?.subtitle || "Don't miss out on these amazing offers"}
                            </p>
                        </div>
                    </div>
