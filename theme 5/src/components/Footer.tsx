    ...
    <footer className="bg-card border-t border-border">
        ...
        <div className="space-y-6">
          <Link to="/" className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-xl overflow-hidden shadow-lg flex items-center justify-center bg-card border border-border">
              <img src="/logo.png" alt="ElectroPulse Logo" className="w-full h-full object-cover" />
            </div>
            <div className="flex flex-col">
              <span className="font-heading font-black text-xl text-foreground tracking-tighter">ELECTRO<span className="text-primary">PULSE</span></span>
              <span className="text-[10px] text-muted-foreground font-bold uppercase tracking-[0.2em] leading-none">Technology</span>
            </div>
          </Link>
      ...
      <div className="border-t border-border bg-secondary/30">
        <div className="container mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-muted-foreground font-medium">© 2026 ElectroPulse Electronics. All rights reserved.</p>
